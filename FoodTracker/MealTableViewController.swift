...
class MealTableViewController: UITableViewController, FoodTrackerProtocol {
    ...
    private func loadSampleMeals() {
        ...
        guard let meal1 = Meal(name: "Caprese Salid", photo: photo1, rating: 4, calories: 100, mealDescription: "Tasty salad")else { fatalError("Unable to instantiate meal1")
            ...
            guard let meal3 = Meal(name: "Pasta with Meatballs", photo: photo3, rating: 3, calories: 2000, mealDescription: "High in carbs, but super super tasty") else {
            fatalError("Unable to instantiate meal2")
        }
...
//        let cell = tableView.dequeueReusableCell(withIdentifier: cfsellIdentifier, for: indexPath)
